...
// If form submitted, insert values into the database.
    if (isset($_REQUEST['no'])){
        ...
        $query = "UPDATE soal_pakar SET no='$no',soalx='$soalx',pilihan_a='$pili_a',pilihan_b='$pili_b',poin_a='$poin_a',poin_b='$poin_b' WHERE no='$no' ";
...
<a href="eedit_ptybts.php" style="text-decoration: none"><input type="button" name="back" value="Batal"></a>
<?php } ?>
</body>
</html>