...
require('../connection.php');
    ...
    if (isset($_REQUEST['id_batas'])){
        ...
        if($result){
            echo "<h3>Batas berhasil diedit.</h3><br/>Klik disini untuk melanjutkan<a href='edit_batas.php'>Edit Batas</a>";
        }
        else{
        	echo "<h3>Data tidak valid.</h3><br/>Klik disini untuk melanjutkan<a href='edit_batas.php'>Edit Batas</a>";
        }
    }else{
?>
...
<a href="edit_batas.php" style="text-decoration: none"><input type="button" name="back" value="Batal"></a>
<?php } ?>
</body>
</html>